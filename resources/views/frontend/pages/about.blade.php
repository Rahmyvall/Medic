        ...
        <section id="about" class="about section">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6">
                        <div class="content">
                            <h2>{{ $about->title ?? 'Committed to Excellence in Healthcare' }}</h2>
                            ...
                            @if ($about->mission)
                                <p><strong>Mission:</strong> {!! nl2br(e($about->mission)) !!}</p>
                            @endif
                                ...
                                <div class="row gy-4">
                                        ...
                                        <div class="stat-item">
                                            <div class="stat-number">
                                                <span data-purecounter-start="0"
                                                    data-purecounter-end="{{ $about->experience_years ?? 25 }}"
                                    ...
                                    <div class="col-sm-6 col-lg-12 col-xl-6">
                                        <div class="stat-item">
                                            <div class="stat-number">
                                                <span data-purecounter-start="0"
                                                    data-purecounter-end="{{ $about->patients_treated ?? 50000 }}"
                            ...
                            <div class="cta-buttons" data-aos="fade-up" data-aos-delay="300">
                                <a href="{{ $about->doctors_link ?? '#' }}" class="btn-primary">Meet Our Doctors</a>
                                <a href="{{ $about->services_link ?? '#' }}" class="btn-secondary">View Our Services</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="image-section" data-aos="fade-left" data-aos-delay="200">
                            ...
                            @if ($images && count($images) > 0)
                                ...
                                <div class="main-image mb-3">
                                    <img src="{{ asset('storage/' . $images[0]) }}" alt="Healthcare image"
                                        class="img-fluid">
                                </div>

                                {{-- Dua gambar tambahan jika ada --}}
                                <div class="image-grid d-flex gap-2">
                                    @for ($i = 1; $i < count($images) && $i <= 2; $i++)
                                        <div class="grid-item flex-fill">
                                            <img src="{{ asset('storage/' . $images[$i]) }}" alt="Healthcare image"
                                                class="img-fluid">
                                        </div>
                                    @endfor
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="certifications-grid">
                            ...
                            <div class="certification-item">
                                <img src="{{ asset('mediTrust-life/assets/img/clients/clients-3.webp') }}" alt="ISO 9001"
                                    class="img-fluid">
                            </div>
                            <div class="certification-item">
                            ...
                            <div class="certification-item">
                                <img src="{{ asset('mediTrust-life/assets/img/clients/clients-5.webp') }}"
                                    alt="Medical Board" class="img-fluid">
                            </div>
                            <div class="certification-item">
                                <img src="{{ asset('mediTrust-life/assets/img/clients/clients-6.webp') }}"
