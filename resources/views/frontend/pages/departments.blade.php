                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="department-card">
                            ...
                            <div class="department-image-wrapper">
                                <img src="{{ asset('mediTrust-life/assets/img/health/cardiology-2.webp') }}"
                            ...
                            <div class="department-content">
                                ...
                                <a href="{{ route('frontend.department-details') }}" class="department-link">Learn More</a>
                            </div>
                        </div>
                        ...
                        <div class="department-card" data-aos="zoom-in" data-aos-delay="350">
                            ...
                            <div class="department-image-wrapper">
                                <img src="{{ asset('mediTrust-life/assets/img/health/dermatology-3.webp') }}"
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="250">
                        <div class="featured-department">
                            ...
                            <div class="featured-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/neurology-4.webp') }}"
                            ...
                            <div class="featured-content">
                                ...
                                <a href="{{ route('frontend.department-details') }}" class="featured-btn">
                                    Explore Department
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="department-card">
                            ...
                            <div class="department-content">
                                ...
                                <a href="{{ route('frontend.department-details') }}" class="department-link">Learn
                                    More</a>
                            </div>
                        </div>
                        ...
                        <div class="department-card" data-aos="zoom-in" data-aos-delay="400">
                            ...
                            <div class="department-image-wrapper">
                                <img src="{{ asset('mediTrust-life/assets/img/health/pediatrics-2.webp') }}"
