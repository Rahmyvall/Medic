...
@section('title', 'Rs Kasih Sayang Ibu')
            ...
            <div class="container-fluid p-0">
                <div class="hero-wrapper">
                    <div class="hero-image">
                        <img src="{{ asset('mediTrust-life/assets/img/health/walpaperbelakang.jpg') }}"
                            alt="Advanced
                ...
                <div class="row gy-5 align-items-center">
                    ...
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                        <div class="about-image position-relative">
                            <div class="about-image">
                                @if ($about && is_array($about->image))
                                    @foreach ($about->image as $img)
                                        <img src="{{ asset('storage/' . $img) }}" alt="About Image"
                                            class="img-fluid rounded-3 mb-3">
                                    @endforeach
                                @else
                                    <img src="{{ asset('mediTrust-life/assets/img/health/facilities-1.webp') }}"
                    ...
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                        <div class="about-content">
                            <h2>{{ $about->title ?? 'Tentang Rumah Sakit Kami' }}</h2>
                            <p class="lead">
                                {!! nl2br(e($about->description ?? 'Kami berdedikasi untuk memberikan pelayanan kesehatan terbaik.')) !!}
                            </p>
                            ...
                            <div class="cta-wrapper mt-4">
                                <a href="{{ route('frontend.about') }}" class="btn btn-primary">Selengkapnya Tentang
                                    Kami</a>
                                <a href="{{ url('/doctors') }}" class="btn btn-outline">Tim Medis Kami</a>
                            </div>
                        </div>
                    </div>
                </div>

                {{-- Sertifikasi (statis, bisa diganti dari DB kalau perlu) --}}
                    ...
                    <div class="col-12">
                        <div class="certifications d-flex justify-content-center gap-4 flex-wrap">
                            <div class="certification-item" data-aos="zoom-in" data-aos-delay="700">
                                <img src="{{ asset('mediTrust-life/assets/img/clients/clients-1.webp') }}"
                                    alt="Certification">
                            </div>
                            <div class="certification-item" data-aos="zoom-in" data-aos-delay="800">
                                <img src="{{ asset('mediTrust-life/assets/img/clients/clients-2.webp') }}"
                                    alt="Certification">
                            </div>
                            <div class="certification-item" data-aos="zoom-in" data-aos-delay="900">
                                <img src="{{ asset('mediTrust-life/assets/img/clients/clients-3.webp') }}"
                                    alt="Certification">
                            </div>
                            <div class="certification-item" data-aos="zoom-in" data-aos-delay="1000">
                                <img src="{{ asset('mediTrust-life/assets/img/clients/clients-4.webp') }}"
                                    alt="Certification">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="department-card">
                            <div class="department-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/cardiology-3.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="department-card">
                            <div class="department-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/neurology-2.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="department-card">
                            <div class="department-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/orthopedics-4.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="department-card">
                            <div class="department-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/pediatrics-3.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="department-card">
                            <div class="department-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/oncology-4.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="department-card">
                            <div class="department-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/emergency-2.webp') }}"
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="400">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="doctor-card">
                            <div class="doctor-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/staff-3.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="doctor-card">
                            <div class="doctor-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/staff-7.webp') }}"
                            ...
                            <div class="doctor-info">
                                ...
                                <div class="appointment-actions">
                                    <a href="#" class="btn btn-outline-primary btn-sm">View Profile</a>
                                    <a href="{{ route('frontend.appointment') }}" class="btn btn-primary btn-sm">Book
                                        Appointment</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="doctor-card">
                            <div class="doctor-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/staff-1.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="doctor-card">
                            <div class="doctor-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/staff-9.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="doctor-card">
                            <div class="doctor-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/staff-5.webp') }}"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="doctor-card">
                            <div class="doctor-image">
                                <img src="{{ asset('mediTrust-life/assets/img/health/staff-12.webp') }}"
