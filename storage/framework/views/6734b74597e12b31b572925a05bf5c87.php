...
<?php $__env->startSection('title', 'Abouts'); ?>
                            ...
                            <div class="stats-container" data-aos="fade-up" data-aos-delay="200">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-sm-6 col-lg-12 col-xl-6">
                                        <div class="stat-item">
                                            <div class="stat-number">
                                                <span data-purecounter-start="0" data-purecounter-end="50000"
                    ...
                    <div class="col-lg-6">
                        <div class="image-section" data-aos="fade-left" data-aos-delay="200">
                            <div class="main-image">
                                <img src="<?php echo e(asset('mediTrust-life/assets/img/health/consultation-3.webp')); ?>"
                                    alt="Healthcare consultation" class="img-fluid">
                            </div>
                            <div class="image-grid">
                                <div class="grid-item">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/facilities-2.webp')); ?>"
                                        alt="Medical facility" class="img-fluid">
                                </div>
                                <div class="grid-item">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/staff-5.webp')); ?>"
                                        alt="Medical staff" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mediclaravel\resources\views/frontend/pages/abouts.blade.php ENDPATH**/ ?>