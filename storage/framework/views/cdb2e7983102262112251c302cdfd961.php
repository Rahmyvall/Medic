        ...
        <div class="row mb-4 px-3">
            <div class="col-12 d-flex justify-content-between align-items-center">
                ...
                <?php if(Auth::user()->role === 'admin'): ?>
                    <?php if($about): ?>
                        <a href="<?php echo e(route('about.edit', $about->id)); ?>" class="btn btn-success">
                                ...
                                <table class="table table-bordered table-hover align-middle">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($about->image): ?>
                                                    <img src="<?php echo e(asset('storage/' . $about->image)); ?>" alt="Gambar About"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mediclaravel\resources\views/about/index.blade.php ENDPATH**/ ?>