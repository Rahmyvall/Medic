                    ...
                    <ul class="nav nav-tabs" role="tablist" data-aos="fade-up" data-aos-delay="200">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="services-primary-tab" data-bs-toggle="tab"
                                data-bs-target="#services-primary" type="button" role="tab">Primary Care</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="services-specialty-tab" data-bs-toggle="tab"
                                data-bs-target="#services-specialty" type="button" role="tab">Specialty Care</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="services-diagnostics-tab" data-bs-toggle="tab"
                                data-bs-target="#services-diagnostics" type="button" role="tab">Diagnostics</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="services-emergency-tab" data-bs-toggle="tab"
                                data-bs-target="#services-emergency" type="button" role="tab">Emergency</button>
                        </li>
                    </ul>
                                ...
                                <div class="col-lg-6">
                                    <div class="service-item">
                                        ...
                                        <div class="service-details">
                                            ...
                                            <p>Cupiditate placeat facere. Delectus quisquam et consequatur laborum sunt
                                                consectetur.</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="service-item">
                                        ...
                                        <div class="service-details">
                                            ...
                                            <p>Voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam
                                                et aut.</p>
                                            <ul class="service-benefits">
                        ...
                        <div class="col-lg-8 mx-auto text-center">
                            <div class="cta-content">
                                ...
                                <div class="cta-buttons">
                                    <a href="<?php echo e(route('frontend.appointment')); ?>" class="btn-book">Book Now</a>
                                    <a href="<?php echo e(route('frontend.contact')); ?>" class="btn-contact">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mediclaravel\resources\views/frontend/pages/services.blade.php ENDPATH**/ ?>