                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="department-card">
                            ...
                            <div class="department-image-wrapper">
                                <img src="<?php echo e(asset('mediTrust-life/assets/img/health/cardiology-2.webp')); ?>"
                                    alt="Cardiology" class="img-fluid" loading="lazy">
                            ...
                            <div class="department-content">
                                ...
                                <a href="<?php echo e(route('frontend.department-details')); ?>" class="department-link">Learn More</a>
                            </div>
                        </div>
                        ...
                        <div class="department-card" data-aos="zoom-in" data-aos-delay="350">
                            ...
                            <div class="department-image-wrapper">
                                <img src="<?php echo e(asset('mediTrust-life/assets/img/health/dermatology-3.webp')); ?>"
                                    alt="Dermatology" class="img-fluid" loading="lazy">
                                <div class="department-stats">
                                    <div class="stat-item">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="250">
                        <div class="featured-department">
                            ...
                            <div class="featured-image">
                                <img src="<?php echo e(asset('mediTrust-life/assets/img/health/neurology-4.webp')); ?>"
                                    alt="Neurology Department" class="img-fluid" loading="lazy">
                            ...
                            <div class="featured-content">
                                ...
                                <a href="<?php echo e(route('frontend.department-details')); ?>" class="featured-btn">
                                    Explore Department
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="department-card">
                            ...
                            <div class="department-image-wrapper">
                                <img src="<?php echo e(asset('mediTrust-life/assets/img/health/orthopedics-4.webp')); ?>"
                                    alt="Orthopedics" class="img-fluid" loading="lazy">
                                <div class="department-stats">
                                    <div class="stat-item">
                            ...
                            <div class="department-content">
                                ...
                                <a href="<?php echo e(route('frontend.department-details')); ?>" class="department-link">Learn
                                    More</a>
                            </div>
                        </div>
                        ...
                        <div class="department-card" data-aos="zoom-in" data-aos-delay="400">
                            ...
                            <div class="department-image-wrapper">
                                <img src="<?php echo e(asset('mediTrust-life/assets/img/health/pediatrics-2.webp')); ?>"
                                    alt="Pediatrics" class="img-fluid" loading="lazy">
                                <div class="department-stats">
                                    <div class="stat-item">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mediclaravel\resources\views/frontend/pages/departments.blade.php ENDPATH**/ ?>