                    ...
                    <div class="col-lg-6">
                        <div class="appointment-info">
                            ...
                            <p class="mb-4">Book your appointment in just a few simple steps. Our healthcare professionals
                                are ready to provide you with the best medical care tailored to your needs.</p>
                            ...
                            <form action="forms/appointment.php" method="post" class="appointment-form php-email-form">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="sent-message">Your appointment request has been sent successfully. We
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mediclaravel\resources\views/frontend/pages/appointment.blade.php ENDPATH**/ ?>