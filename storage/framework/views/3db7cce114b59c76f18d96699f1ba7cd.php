...
unset($__errorArgs, $__bag); ?>"
                                    id="name" name="name" value="<?php echo e(old('name', $doctor->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    id="specialty" name="specialty" value="<?php echo e(old('specialty', $doctor->specialty)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="bio" name="bio" rows="5"><?php echo e(old('bio', $doctor->bio)); ?></textarea>
                                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?php $__errorArgs = ['experience_years'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    id="experience_years" name="experience_years" min="0" max="99"
                                    value="<?php echo e(old('experience_years', $doctor->experience_years)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    id="email" name="email" value="<?php echo e(old('email', $doctor->email)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('linkedin_url', $doctor->linkedin_url)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('twitter_url', $doctor->twitter_url)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if($doctor->photo): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e(asset('storage/' . $doctor->photo)); ?>" alt="Foto Dokter"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="<?php echo e(route('doctors.index')); ?>" class="btn btn-secondary me-3">Batal</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mediclaravel\resources\views/doctors/edit.blade.php ENDPATH**/ ?>