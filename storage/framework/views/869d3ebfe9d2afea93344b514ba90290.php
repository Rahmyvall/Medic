...
<?php $__env->startSection('title', 'Rs Kasih Sayang Ibu'); ?>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-5 align-items-center">
                    ...
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                        <div class="about-image position-relative">
                            <div class="about-image">
                                <?php if($about && is_array($about->image)): ?>
                                    <?php $__currentLoopData = $about->image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <img src="<?php echo e(asset('storage/' . $img)); ?>" alt="About Image"
                                            class="img-fluid rounded-3 mb-3">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/facilities-1.webp')); ?>"
                                        alt="Default" class="img-fluid rounded-3 mb-4">
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                        <div class="about-content">
                            <h2><?php echo e($about->title ?? 'Tentang Rumah Sakit Kami'); ?></h2>
                            <p class="lead">
                                <?php echo nl2br(e($about->description ?? 'Kami berdedikasi untuk memberikan pelayanan kesehatan terbaik.')); ?>

                            </p>

                            <?php if($about && $about->vision): ?>
                                <h4 class="mt-4 text-primary">Visi</h4>
                                <p><?php echo nl2br(e($about->vision)); ?></p>
                            <?php endif; ?>

                            <?php if($about && $about->mission): ?>
                                <h4 class="mt-4 text-primary">Misi</h4>
                                <p><?php echo nl2br(e($about->mission)); ?></p>
                            <?php endif; ?>
                            ...
                            <div class="row g-4 mt-4">
                                <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
                                    <div class="feature-item">
                                        ...
                                        <p>Kami memberikan pelayanan dengan empati dan profesionalisme tinggi.</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6" data-aos="fade-up" data-aos-delay="500">
                                    <div class="feature-item">
                                        ...
                                        <p>Didukung oleh teknologi medis mutakhir dan tenaga ahli berpengalaman.</p>
                                    </div>
                                </div>
                            </div>

                            <div class="cta-wrapper mt-4">
                                <a href="<?php echo e(route('frontend.about')); ?>" class="btn btn-primary">Selengkapnya Tentang
                                    Kami</a>
                                <a href="<?php echo e(url('/doctors')); ?>" class="btn btn-outline">Tim Medis Kami</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-5 pt-4 certifications-row" data-aos="fade-up" data-aos-delay="600">
                    <div class="col-12 text-center mb-4">
                        <h4 class="certification-title">Akreditasi & Penghargaan</h4>
                    </div>
                    <div class="col-12">
                        <div class="certifications d-flex justify-content-center gap-4 flex-wrap">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="doctor-card">
                            ...
                            <div class="doctor-info">
                                ...
                                <div class="appointment-actions">
                                    <a href="#" class="btn btn-outline-primary btn-sm">View Profile</a>
                                    <a href="<?php echo e(route('frontend.appointment')); ?>" class="btn btn-primary btn-sm">Book
                                        Appointment</a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mediclaravel\resources\views/frontend/pages/homepage.blade.php ENDPATH**/ ?>