...
<html lang="en">
    ...
    <head>
        ...
        <title>Kasih Sayang Ibu Hospital</title>
        <meta name="description" content="">
        <meta name="keywords" content="">

        <!-- Favicons -->
        <link href="<?php echo e(asset('mediTrust-life/assets/img/logo2.webp')); ?>" rel="icon">
        <link href="<?php echo e(asset('mediTrust-life/assets/img/logo2.webp')); ?>" rel="apple-touch-icon">

        <!-- Fonts -->
        <link href="<?php echo e(asset('mediTrust-life/https://fonts.googleapis.com')); ?>" rel="preconnect">
        <link href="<?php echo e(asset('mediTrust-life/https://fonts.gstatic.com')); ?>" rel="preconnect" crossorigin>
        <link
            href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
            rel="stylesheet">

        <!-- Vendor CSS Files -->
        <link href="<?php echo e(asset('mediTrust-life/assets/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('mediTrust-life/assets/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('mediTrust-life/assets/vendor/aos/aos.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('mediTrust-life/assets/vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('mediTrust-life/assets/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('mediTrust-life/assets/vendor/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet">

        <!-- Main CSS File -->
        <link href="<?php echo e(asset('mediTrust-life/assets/css/main.css')); ?>" rel="stylesheet">
    ...
    <body class="index-page">
        ...
        <header id="header" class="header d-flex align-items-center fixed-top">
            <div
                ...
                <a href="index.html" class="logo d-flex align-items-center">
                    <img src="<?php echo e(asset('mediTrust-life/assets/img/Kasih-Ibu-Hospital-logo.webp')); ?>"
                        alt="MediTrust Logo" class="img-fluid" style="height: 40px; margin-right: 8px;">
                </a>
        ...
        <main class="main">
                ...
                <div class="container-fluid p-0">
                    <div class="hero-wrapper">
                        <div class="hero-image">
                            <img src="<?php echo e(asset('mediTrust-life/assets/img/health/walpaperbelakang.jpg')); ?>"
                                alt="Advanced
                                Healthcare" class="img-fluid">
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-7 col-md-10" data-aos="fade-right" data-aos-delay="100">
                                        <div class="content-box">
                                            ...
                                            <h1 data-aos="fade-up" data-aos-delay="200">Perawatan Kesehatan Modern
                                                untuk Kehidupan Keluarga yang Lebih Sehat</h1>
                                            <p data-aos="fade-up" data-aos-delay="250">Kami berkomitmen memberikan
                                                layanan kesehatan yang menyeluruh, modern, dan penuh kepedulian..</p>
                    ...
                    <div class="row gy-5 align-items-center">
                        <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                            <div class="about-image">
                                <img src="<?php echo e(asset('mediTrust-life/assets/img/health/facilities-1.webp')); ?>"
                        ...
                        <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                            <div class="about-content">
                                ...
                                <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
                        ...
                        <div class="col-12">
                            <div class="certifications">
                                ...
                                <div class="certification-item" data-aos="zoom-in" data-aos-delay="900">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/clients/clients-3.webp')); ?>"
                                        alt="Certification">
                                </div>
                ...
                <div class="container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="department-card">
                                ...
                                <div class="department-content">
                                    ...
                                    <h3>Cardiology</h3>
                                    <p>Comprehensive cardiovascular care with advanced diagnostic techniques and
                                        treatment options for heart conditions, ensuring optimal cardiac health for all
                                        patients.</p>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="department-card">
                                <div class="department-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/neurology-2.webp')); ?>"
                                        alt="Neurology Department" class="img-fluid">
                                </div>
                                <div class="department-content">
                                    <div class="department-icon">
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                            <div class="department-card">
                                <div class="department-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/orthopedics-4.webp')); ?>"
                                ...
                                <div class="department-content">
                                    ...
                                    <h3>Orthopedics</h3>
                                    <p>Advanced musculoskeletal care focusing on bones, joints, and muscles with
                                        innovative surgical and non-surgical treatment approaches for mobility
                                        restoration.</p>
                                    <a href="department-details.html" class="btn-learn-more">
                                        <span>Learn More</span>
                                        <i class="fas fa-arrow-right"></i>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="department-card">
                                <div class="department-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/pediatrics-3.webp')); ?>"
                                        alt="Pediatrics Department" class="img-fluid">
                                </div>
                                <div class="department-content">
                                    <div class="department-icon">
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div class="department-card">
                                <div class="department-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/oncology-4.webp')); ?>"
                                        alt="Oncology Department" class="img-fluid">
                                </div>
                                <div class="department-content">
                                    <div class="department-icon">
                                    ...
                                    <p>Comprehensive cancer care with multidisciplinary approach, offering advanced
                                        treatment options, clinical trials, and compassionate support throughout the
                                        cancer journey.</p>
                                    <a href="department-details.html" class="btn-learn-more">
                                        <span>Learn More</span>
                                        <i class="fas fa-arrow-right"></i>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                            <div class="department-card">
                                <div class="department-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/emergency-2.webp')); ?>"
                                        alt="Emergency Department" class="img-fluid">
                                </div>
                                <div class="department-content">
                                    <div class="department-icon">
                                    ...
                                    <p>Round-the-clock emergency medical services with rapid response capabilities,
                                        state-of-the-art equipment, and experienced emergency physicians for critical
                                        care.</p>
                                    <a href="department-details.html" class="btn-learn-more">
                                        <span>Learn More</span>
                                        <i class="fas fa-arrow-right"></i>
            ...
            <section id="find-a-doctor" class="find-a-doctor section">
                ...
                <!-- Section Title -->
                <div class="container section-title" data-aos="fade-up">
                    <h2>Temukan Ahli Kesehatan Anda</h2>
                    <p>Percayakan perawatan Anda pada tenaga medis profesional dan berpengalaman.</p>
                </div><!-- End Section Title -->
                ...
                <div class="container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="row" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="doctor-card">
                                <div class="doctor-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/staff-3.webp')); ?>"
                                        alt="Dr. Sarah Mitchell" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="doctor-card">
                                <div class="doctor-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/staff-7.webp')); ?>"
                                        alt="Dr. Michael Rodriguez" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="doctor-card">
                                <div class="doctor-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/staff-1.webp')); ?>"
                                        alt="Dr. Emily Chen" class="img-fluid">
                                    <div class="availability-badge online">Available</div>
                                </div>
                                <div class="doctor-info">
                                    <h5>Dr. Emily Chen</h5>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="doctor-card">
                                <div class="doctor-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/staff-9.webp')); ?>"
                                        alt="Dr. James Thompson" class="img-fluid">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="doctor-card">
                                <div class="doctor-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/staff-5.webp')); ?>"
                                        alt="Dr. Lisa Anderson" class="img-fluid">
                                    <div class="availability-badge online">Available</div>
                                </div>
                                <div class="doctor-info">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="doctor-card">
                                <div class="doctor-image">
                                    <img src="<?php echo e(asset('mediTrust-life/assets/img/health/staff-12.webp')); ?>"
                                        alt="Dr. Robert Kim" class="img-fluid">
                                    <div class="availability-badge online">Available</div>
                                </div>
                                <div class="doctor-info">
                                    <h5>Dr. Robert Kim</h5>
                        ...
                        <div class="col-lg-8 col-md-10 mx-auto">
                            ...
                            <div class="emergency-alert" data-aos="zoom-in" data-aos-delay="100">
                                ...
                                <div class="alert-content">
                                    ...
                                    <p>If you are experiencing a life-threatening emergency, call 911 immediately or go
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="emergency-list">
                                            <li><i class="bi bi-check-circle"></i> Chest pain or difficulty breathing
                                            </li>
        ...
        <footer id="footer" class="footer position-relative light-background">
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6 footer-about">
                        ...
                        <div class="footer-contact pt-3">
                            <p class="mt-3"><strong>Phone:</strong> <span> (0361) 300 3030</span></p>
                            <p><strong>Email:</strong> <span>Rskasihsayangibu@gmail.com</span></p>
                        </div>
                    ...
                    <div class="col-lg-2 col-md-3 footer-links">
                        <h4>Our Services</h4>
                        <ul>
                            <li><a href="#">Medical Check Up for Visa
                                    Oncology</a></li>
                            <li><a href="#">Orthopaedic & Traumatology
                                    Urology</a></li>
                            <li><a href="#">Digestive & Endoscopy
                                    Eye</a></li>
                            <li><a href="#">Dialysis</a></li>
                            <li><a href="#">Brain & Spine</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Emergency Unit & Ambulance
                                    Operating Room</a></li>
                            <li><a href="#">Rawat Inap
                                    Outpatient</a></li>
                            <li><a href="#">Delivery Room
                                    Radiology</a></li>
                    ...
                    <div class="col-lg-2 col-md-3 footer-links">
                        ...
                        <ul>
                            <li><a href="#">Bali Dental and Implants Centre (BDIC)</a></li>
                            <li><a href="#">Bali Physio & Sports Injury Centre (BPSI)
                                </a></li>
                            <li><a href="#">Kasih Ibu Heart & Cerebrovascular Centre (HCC)
                                </a></li>
                            <li><a href="#">Hyperbaric & Diving Medicine Centre (HDMC)
                                </a></li>
                            <li><a href="#">Hovi Care Bali (Hovi Club Teuku Umar & Hovi Assisted Saba)</a></li>
                        </ul>
                    </div>
            ...
            <div class="container copyright text-center mt-4">
                <p>© <span>Copyright © 2025 Kasih Ibu Hospital. All rights reserved.</span></span></p>
            </div>
        ...
        <!-- Vendor JS Files -->
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/php-email-form/validate.js')); ?>"></script>
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/aos/aos.js')); ?>"></script>
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/purecounter/purecounter_vanilla.js')); ?>"></script>
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js')); ?>"></script>
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/isotope-layout/isotope.pkgd.min.js')); ?>"></script>
        <script src="<?php echo e(asset('mediTrust-life/assets/vendor/glightbox/js/glightbox.min.js')); ?>"></script>

        <!-- Main JS File -->
        <script src="<?php echo e(asset('mediTrust-life/assets/js/main.js')); ?>"></script>

    </body>

</html>
<?php /**PATH C:\laragon\www\mediclaravel\resources\views/homepage.blade.php ENDPATH**/ ?>